...
public class StudentController {
    ...
    @PutMapping("/update/StuInformationByPhone")
    public String updateStuInformationByPhone(String stu_name, String idcard, String college, String major, String classes, String stu_id, String nation, String address, String phone) {

        int success=studentMapper.updateInformationByPhone(stu_name,idcard,college,major,classes,stu_id,nation,address,phone);
        return success==1?"success":"fail";
    }
